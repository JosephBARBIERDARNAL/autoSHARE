...
HELPCOLUMNS = """
        ...
        """
HELPNUMERICAL = """
        Define which variables should be considered as numerical. Numerical variables are
        continuous variables that can take any value within a range. They can be integers or
        floats.
        """
HELPCATEGORICAL = """
        Define which variables should be considered as categorical. Categorical variables are
        variables that can take on one of a limited, and usually fixed, number of possible values.
        Boolean variables should be considered as categorical.
        """
HELPUPLOADCONFIG = """
